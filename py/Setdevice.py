...
from communication import register
from communication import exam
from communication import login
from communication import speech
from communication import view
from communication import configFTP
from communication import configDB
...
class setdevice(QMainWindow):
    ...
    def receiveIdslot(self,idnum,choice):
        ...
        if choice == 1:#new_stu
            ...
            name = self.ui.name_lineEdit_2.text("000000")
    ...
    def spkshow(self):
        ...
        cameraDevice = QByteArray()
        self.setCamera(cameraDevice, -1)#关闭摄像头
